        ...
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-[#000000] text-[14px] md:text-[15px] max-w-150 mx-auto mb-10 font-bold px-4 md:px-0 opacity-90">
              Let&apos;s demonstrate how we can add value to your company with
              our suite of payment solutions.
            </p>
            <a
              href="mailto:info@payvantage.com.ng?subject=Book%20A%20Demo"
              className="bg-brand-primary text-white px-10 py-3.5 rounded-lg text-[13px] font-bold border-b-4 border-indigo-900/60 hover:translate-y-0.5 hover:border-b-2 transition-all shadow-md mb-10 inline-block"
            >
              Book A Demo
            </a>
          </ScrollReveal>
